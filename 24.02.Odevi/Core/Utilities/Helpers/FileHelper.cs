...
namespace Core.Utilities.Helpers
{
    public class FileHelper
    {
        public static string AddAsync(IFormFile file)
        {
            ...
            try
            {
                if (!Directory.Exists(result.directory))
                {
        ...
        public static (string newPath, string Path2, string directory) newPath(IFormFile file)
        {
            ...
            return (result, $"\\Images\\{creatingUniqueFilename}", Environment.CurrentDirectory + @"\wwwroot\Images");
        }
